...
- **Лендинги и многостраничные сайты** — адаптив от 320px, анимации, быстрая загрузка
- **Telegram-боты** — запись, каталог, рассылки, автоматизация под бизнес-задачи
- **Telegram Mini Apps** — полноценные приложения внутри Telegram
- **Интеграции API и парсеры** — внешние сервисы, автоматизация процессов

Закрываю проект целиком — от вёрстки до сервера. Беру первые заказы по сниженному ценнику в обмен на честный отзыв.
...
### [Meridian Noir](https://egordev.com/meridian-noir/)
Промо-сайт вымышленного парфюмерного дома без единого файла изображений. В центре работающие солнечные часы с настоящим астрономическим расчётом для пяти площадок, а гномон в них — 3D-флакон, написанный кодом: гранёное стекло, настой с колыханием, помпа, этикетка. Шесть сцен срежиссированы прокруткой, пять формул переключаются с перетеканием дня.

`Three.js · WebGL` `GSAP` `Lenis` `TypeScript`

Примерная стоимость такой работы: **230 000 – 450 000 ₽** · для западных клиентов $5 000 – 11 000

---

### [Keyboard Showcase — VOID65](https://egordev.com/void65/)
...
[All Rights Reserved](LICENSE) — код и дизайн этого репозитория защищены авторским правом. Копирование, модификация и использование без письменного разрешения запрещены.
